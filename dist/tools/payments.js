...
export const generatePaymentLinkTool = {
    ...
    description: "Create a payment link that can be shared with a customer. Returns a URL the customer can use to complete the payment. Supports cards, Bizum, and other MONEI-enabled payment methods.",
    annotations: {
        readOnlyHint: false,
    ...
    inputSchema: {
        ...
        properties: {
            amount: {
                type: "number",
                description: "Payment amount in the smallest currency unit (e.g., cents). For €10.50, use 1050.",
            },
            currency: {
                type: "string",
            ...
            orderId: {
                type: "string",
                description: "Your internal order ID for reference. Must be unique per payment.",
            },
            description: {
                type: "string",
            ...
            expireAt: {
                type: "number",
                description: "Unix timestamp (seconds) when the payment link expires. Optional.",
            },
        },
...
export const getPaymentTool = {
    ...
    description: "Retrieve the full details and current status of a payment by its ID. Returns amount, status, payment method, customer info, and timestamps.",
    annotations: {
        readOnlyHint: true,
...
export const listPaymentsTool = {
    name: "list_payments",
    title: "List Payments",
    description: "List and search payments with optional filters. Returns a paginated list of transactions. Useful for checking recent sales, finding specific orders, or reviewing payment history.",
    annotations: {
        readOnlyHint: true,
        destructiveHint: false,
        idempotentHint: true,
    ...
    inputSchema: {
        ...
        properties: {
            ...
            status: {
                type: "string",
                description: "Filter by status: SUCCEEDED, FAILED, PENDING, AUTHORIZED, CANCELED, EXPIRED, REFUNDED, PARTIALLY_REFUNDED.",
                enum: [
                    "SUCCEEDED",
                    "FAILED",
                    "PENDING",

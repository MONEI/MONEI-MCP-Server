...
export const getSubscriptionTool = {
    ...
    description: "Retrieve the full details and current status of a subscription by its ID. Returns amount, interval, status, and billing period information.",
    annotations: {
        readOnlyHint: true,
...
export const listSubscriptionsTool = {
    ...
    description: "List subscriptions with optional filters. Returns active, paused, and past subscriptions.",
    annotations: {
        readOnlyHint: true,
        destructiveHint: false,
        idempotentHint: true,
    ...
    inputSchema: {
        ...
        properties: {
            limit: {
                type: "number",
                description: "Maximum number of subscriptions to return (1-100, default 10).",
                default: 10,
            },
            offset: {
                type: "number",
